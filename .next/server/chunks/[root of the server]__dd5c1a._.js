...
(()=>{
    const e = new Error("Cannot find module '@/models/CoilState'");
...
async function handler(req, res) {
    if (req.method === "POST") {
        ...
        try {
            const result = await CoilState.findByIdAndUpdate("current", {
                coilsHex,
                updatedAt: new Date()
            }, {
                upsert: true,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dd5c1a._.js.map